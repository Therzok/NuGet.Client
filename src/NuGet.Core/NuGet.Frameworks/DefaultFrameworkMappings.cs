...
namespace NuGet.Frameworks
{
    ...
    sealed class DefaultFrameworkMappings : IFrameworkMappings
    {
        ...
        private static readonly Lazy<KeyValuePair<string, string>[]> PlatformShortNamesLazy = new Lazy<KeyValuePair<string, string>[]>(() =>
        {
            return new[]
            {
                new KeyValuePair<string, string>(FrameworkConstants.FrameworkPlatforms.Android, "android"),
                new KeyValuePair<string, string>(FrameworkConstants.FrameworkPlatforms.IOS, "ios"),
                new KeyValuePair<string, string>(FrameworkConstants.FrameworkPlatforms.MacOS, "macos"),
                new KeyValuePair<string, string>(FrameworkConstants.FrameworkPlatforms.TvOS, "tvos"),
                new KeyValuePair<string, string>(FrameworkConstants.FrameworkPlatforms.WatchOS, "watchos"),
                new KeyValuePair<string, string>(FrameworkConstants.FrameworkPlatforms.Windows, "windows"),
            };
        });
